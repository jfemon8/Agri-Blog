            ...
            <div class="box round first grid">
               ...
               if($_SERVER['REQUEST_METHOD']=='POST'){
                ...
                $details = mysqli_real_escape_string($db->link, $_POST['details']);
                        ...
                        $query = "UPDATE user SET name='$name', username='$username', email='$email', details='$details' where id='$userid'";
                        $updated_row = $db->update($query);
                        if ($updated_row) {
                            echo "<span style='color: green; font-size: 18px;'>Data Updated Successfully.</span>";
                        }
                        else {
                            echo "<span style='color: red; font-size: 18px;'>Data is not Updated!</span>";
                        }
                    }
                ?>
