                ...
                if($title==""){
                    ...
                    if(!empty($file_name)){
                        ...
                        elseif (in_array($file_ext, $permited) === false) {
                            ...
                            $query = "UPDATE slider SET title='$title', image='$uploaded_image' WHERE id='$sliderid'";
                            $updated_row = $db->update($query);
                            if ($updated_row) {
                                echo "<span style='color: green; font-size: 18px;'>Slider Updated Successfully.</span>";
                            }
                            else {
                                echo "<span style='color: red; font-size: 18px;'>Slider is not Updated!</span>";
                            }
                        }
                    }
                    else{
                        ...
                        $updated_row = $db->update($query);
                        if ($updated_row) {
                            echo "<span style='color: green; font-size: 18px;'>Title of the Slider Updated Successfully.</span>";
                        }
                        else {
                            echo "<span style='color: red; font-size: 18px;'>Title of the Slider is not Updated!</span>";
                        }
                    }
                }
            }
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="<?php echo $result['image']; ?>" height="200px" width="500px"/></br>
